...
# it is exposed lazily (PEP 562) to keep ``import opensims`` light and offline.
_LAZY = {"build_runtime", "build_inference", "build_storage"}


def __getattr__(name: str) -> Any:
    """Lazily resolve the builder facade from :mod:`opensims.runtime.builder`."""
    if name in _LAZY:
        from opensims.runtime import builder
