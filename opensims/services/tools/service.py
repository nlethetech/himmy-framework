...
if TYPE_CHECKING:  # pragma: no cover - typing only, avoids an import cycle
    ...
    from opensims.services.inference.models import BoundTool
...
def _validate_against_schema(value: Any, schema: dict[str, Any]) -> str | None:
    ...
    :func:`opensims.services.tools.validation.validate_against_schema`.
    """
...
class ToolService:
    ...
    def bound_tools(self, names: list[str] | None = None) -> list[BoundTool]:
        ...
        from opensims.services.inference.models import BoundTool, ToolReturnRecord
