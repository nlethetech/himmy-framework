...
from opensims.services.inference.cache import InferenceCache, NoopInferenceCache
...
if TYPE_CHECKING:  # pragma: no cover - typing only
    from opensims.core.events import EventSink
    from opensims.services.inference.client_manager import ClientManager
...
class InferenceService:
    ...
    async def _run_once(self, request: InferenceRequest) -> InferenceResponse:
        ...
        INVALID_REQUEST; ``OpenSimsError`` and any other exception are normalized
