# Himmy — IMPROVEMENTS (production-hardening work-list)
...
> `HIMMY_TEST_POSTGRES_DSN` is set.
...
## INF — INFERENCE kernel (himmy/services/inference/)
...
- **files:** himmy/services/inference/pydantic_ai_manager.py, himmy/services/inference/models.py
...
- **files:** himmy/services/inference/service.py
...
- **files:** himmy/services/inference/pydantic_ai_manager.py, himmy/services/inference/client_manager.py
...
- **files:** himmy/services/inference/service.py, himmy/services/inference/pydantic_ai_manager.py, himmy/services/inference/client_manager.py
...
- **files:** himmy/services/inference/models.py
...
- **files:** himmy/services/inference/service.py, himmy/services/inference/models.py
...
- **files:** himmy/services/inference/client_manager.py, himmy/services/inference/service.py, tests/inference/test_inference_service.py
...
- **fix:** Mirror LLMConfig's conflict checks in InferenceRequest's model_validator: if an explicit response_format contradicts output_json_schema/workflow, raise ValueError at construction. At minimum reject WORKFLOW with workflow=None and STRUCTURED_OUTPUT with output_json_schema=None so the stub's runtime HimmyError (client_manager.py:180,211) becomes a construction-time error.


---

## CK — CONTEXT + KNOWLEDGE kernels (himmy/services/context/*, himmy/services/knowledge/*)
...
- **category:** fidelity-gap · **impact:** high · **effort:** L
- **files:** himmy/services/storage/postgres.py, himmy/services/knowledge/service.py
- **current:** md-knowledge states (twice, in a Status banner and the Backends table) that 'Postgres + pgvector ... is shipped' with create_knowledge_schema(vector_dim, embedding_column_type, index_method), vector(N)/halfvec(N) columns, ivfflat/hnsw, auto-detect from pg_attribute, and cascade-delete. himmy/services/storage/postgres.py (413 lines) has NO knowledge_bases/knowledge_documents/knowledge_chunks methods and no create_knowledge_schema at all; every data method just raises self._no_conn(). KnowledgeBase.__init__ accepts `storage` but ignores it entirely, keeping everything in process-local dicts (service.py:72-76).
...
- **category:** robustness · **impact:** high · **effort:** S
- **files:** himmy/services/knowledge/service.py
...
- **files:** himmy/services/context/service.py, himmy/services/knowledge/service.py
...
- **category:** robustness · **impact:** medium · **effort:** S
- **files:** himmy/services/knowledge/chunker.py
...
- **category:** robustness · **impact:** medium · **effort:** S
- **files:** himmy/services/context/service.py, himmy/services/storage/service.py
...
- **files:** himmy/services/knowledge/service.py, himmy/services/knowledge/embedder.py
...
- **files:** himmy/services/knowledge/models.py, himmy/services/knowledge/service.py
...
- **files:** himmy/services/storage/postgres.py, examples/06_postgres_storage.py
...
- **files:** himmy/application/services.py, himmy/services/storage/service.py, himmy/services/storage/postgres.py
...
- **category:** robustness · **impact:** high · **effort:** M
- **files:** himmy/entities/postgres.py
...
- **fix:** Run get_latest + insert inside a single transaction with `SELECT ... FOR UPDATE` (or an advisory lock on stable_id), and have new_version's INSERT omit ON CONFLICT (or use `RETURNING` and verify a row was actually inserted) so a lost version raises HimmyError instead of a false success. Mirror the in-memory error semantics.
...
- **files:** himmy/entities/postgres.py, himmy/services/storage/postgres.py
...
- **category:** production · **impact:** medium · **effort:** M
- **files:** himmy/services/storage/postgres.py, himmy/entities/postgres.py
...
- **category:** fidelity-gap · **impact:** medium · **effort:** M
- **files:** himmy/services/storage/postgres.py, himmy/core/events.py
...
- **files:** himmy/entities/registry.py, himmy/entities/postgres.py
...
- **category:** robustness · **impact:** medium · **effort:** S
- **files:** himmy/entities/records.py, tests/test_entities.py
...
- **category:** robustness · **impact:** medium · **effort:** S
- **files:** himmy/entities/records.py, himmy/entities/registry.py
...
- **category:** dx · **impact:** low · **effort:** S
- **files:** himmy/services/storage/models.py, himmy/entities/records.py
...
## TP — TOOLS + PROMPTS kernels (himmy/services/tools/*, himmy/services/prompts/*)
...
- **category:** robustness · **impact:** high · **effort:** M
- **files:** himmy/services/tools/service.py
...
- **category:** fidelity-gap · **impact:** high · **effort:** M
- **files:** himmy/services/tools/service.py, himmy/services/tools/models.py
...
- **category:** fidelity-gap · **impact:** medium · **effort:** M
- **files:** himmy/services/tools/runtime_adapter.py
...
- **category:** dx · **impact:** medium · **effort:** M
- **files:** tests/tools/test_tool_service.py, himmy/services/tools/service.py
...
- **category:** robustness · **impact:** medium · **effort:** S
- **files:** himmy/services/prompts/manager.py
...
- **files:** himmy/services/prompts/mapper.py
...
- **category:** dx · **impact:** low · **effort:** S
- **files:** himmy/services/tools/registry.py
...
## RO — Runtime + Orchestrators (himmy/runtime/single_agent.py, himmy/orchestrators/workflow.py)
...
- **category:** production · **impact:** high · **effort:** M
- **files:** himmy/runtime/single_agent.py, himmy/orchestrators/workflow.py
...
- **files:** himmy/orchestrators/workflow.py
...
- **category:** robustness · **impact:** medium · **effort:** M
- **files:** himmy/orchestrators/workflow.py, himmy/runtime/single_agent.py
...
- **category:** robustness · **impact:** medium · **effort:** S
- **files:** himmy/runtime/single_agent.py, himmy/agents/base_agent/thread.py
...
- **files:** himmy/runtime/single_agent.py, himmy/services/inference/models.py
...
- **category:** production · **impact:** high · **effort:** L
- **files:** /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/application/services.py, /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/api/app.py
...
- **category:** production · **impact:** high · **effort:** L
- **files:** /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/api/deps.py, /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/services/storage/postgres.py
...
- **category:** robustness · **impact:** high · **effort:** M
- **files:** /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/application/services.py, /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/api/routers/runs.py, /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/api/routers/context.py, /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/services/storage/service.py
...
- **category:** fidelity-gap · **impact:** medium · **effort:** L
- **files:** /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/services/evaluation/metrics.py
...
- **category:** robustness · **impact:** medium · **effort:** M
- **files:** /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/application/services.py
...
- **category:** robustness · **impact:** medium · **effort:** M
- **files:** /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/application/services.py, /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/services/storage/service.py
...
- **category:** production · **impact:** medium · **effort:** M
- **files:** /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/api/routers/runs.py, /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/api/routers/recommendations.py, /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/application/services.py
...
- **category:** dx · **impact:** medium · **effort:** M
- **files:** /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/api/routers/dashboard.py, /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/api/routers/runs.py, /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/api/app.py
...
- **fix:** Define typed response models (DashboardSummary, a paginated RunList, an ErrorResponse) and declare responses={404: ...} on routes for accurate OpenAPI. Register the internal key as an APIKeyHeader security scheme so it shows in docs. Add a global exception handler mapping HimmyError -> structured error body. Consider a response_model on POST /v1/runs that hides internal fields.

### AAEO-10 · MetricEvaluator protocol is sync but the natural production impls (LLM judge) are async
- **category:** capability · **impact:** medium · **effort:** M
- **files:** /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/services/evaluation/metrics.py, /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/services/evaluation/service.py
...
- **files:** /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/api/app.py
...
- **category:** robustness · **impact:** medium · **effort:** S
- **files:** /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/services/evaluation/service.py, /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/services/evaluation/metrics.py
...
- **files:** /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/services/evaluation/service.py, /Users/samriddhagc/LocalProjects/himmy-agent-test/himmy/application/services.py
