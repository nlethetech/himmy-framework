...
Gated by ``OPENSIMS_TEST_POSTGRES_DSN``: when it is unset this prints a skip
...
from opensims.entities.registry import EntityRegistry  # noqa: E402
from opensims.runtime.single_agent import SingleAgentRuntime  # noqa: E402
from opensims.services.storage.postgres import (  # noqa: E402
    STORAGE_DDL,
...
async def main() -> None:
    ...
    dsn = os.environ.get("OPENSIMS_TEST_POSTGRES_DSN")

    print("=== Example 06: Postgres storage ===")
    if not dsn:
        print("OPENSIMS_TEST_POSTGRES_DSN is not set — skipping (offline default).")
        print(
